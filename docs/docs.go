...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateSnapRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/wallet/withdrawals": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter: PENDING, APPROVED, TRANSFERRED, REJECTED",
                        "name": "status",
                        "in": "query"
                    },
                    {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.AdminReviewRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/wallet/withdrawals/{id}/transfer": {
            "patch": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/partner/wallet/transactions": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Jumlah per halaman (default: 20, max: 100)",
                        "name": "limit",
                        "in": "query"
                    }
                ],
        ...
        "/partner/wallet/withdraw": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Data penarikan",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateWithdrawRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/partner/wallet/withdrawals": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter status: PENDING, APPROVED, TRANSFERRED, REJECTED",
                        "name": "status",
                        "in": "query"
                    },
                    {
