...
func (h *UserHandler) ListUsers(c *gin.Context) {
	...
	if err != nil {
		apperrors.Write(c, apperrors.New("TENANT_NOT_FOUND", "Tenant context is required", http.StatusUnauthorized))
		return
	}
...
func (h *UserHandler) GetUserDetail(c *gin.Context) {
	...
	if err := c.ShouldBindUri(&uri); err != nil {
		apperrors.Write(c, apperrors.New("VALIDATION_ERROR", "Parameter user id tidak valid", http.StatusUnprocessableEntity))
		return
	}
...
func (h *UserHandler) ListAllUsersForAdmin(c *gin.Context) {
	...
	if err := c.ShouldBindQuery(&req); err != nil {
		apperrors.Write(c, apperrors.New("VALIDATION_ERROR", "Parameter query filter role tidak valid", http.StatusUnprocessableEntity))
		return
	}
